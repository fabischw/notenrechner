...
comment on column lehrer.lehrer_origin is 'Urprungsschule des Lehrers (c = Cusanus, w = Wendalinum, a = AJG)';
comment on column lehrer.lehrer_wohnort is 'Wohnort des Lehrers';
